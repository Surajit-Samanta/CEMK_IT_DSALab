...
struct Node* insertAtLocation(struct Node *head, int data, int position) {
    struct Node *newNode = createNode(data);
    if (head == NULL) {
        return newNode;
    }
...
int main() {
    ...
    while (1) {
        ...
        printf("5. Insertion at a given location\n");
        printf("6. Deletion from beginning\n");
        printf("7. Deletion from end\n");
        printf("8. Deletion from a given location\n");
        printf("9. Exit\n");
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 5:
                ...
                printf("Data inserted at location %d successfully\n", position);
                break;
            case 6:
